...
<div class="container-fluid pt-4">
    ...
    <div class="row px-xl-5 pb-3" id='top'>
            ...
            <div class="card product-item border-0 mb-4">
                ...
                <div class="card-footer d-flex justify-content-between bg-light border">
                    <a href="<?=json_decode(file_get_contents('env.json'))->base_url?>/detail?id=<?=$data['id']?>"
                        ...
                        Detail</a>
                    <button data-id="<?= $data['id'] ?>" onclick="addToCart(`<?= $data['id'] ?>`)" id="addToCart" class="btn btn-sm text-dark p-0"><i
            ...
            <div class="card product-item border-0 mb-4">
                ...
                <div class="card-footer d-flex justify-content-between bg-light border">
                    <a href="<?=json_decode(file_get_contents('env.json'))->base_url?>/detail?id=<?=$data['id']?>"
                        ...
                        Detail</a>
                    <button 
                        data-id="<?= $data['id'] ?>" onclick="addToCart(`<?= $data['id'] ?>`)" id="addToCart" class="btn btn-sm text-dark p-0"><i
