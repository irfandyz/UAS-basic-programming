...
<body>
    ...
    <div class="row align-items-center py-3 px-xl-5 bg-main mb-4">
        <div class="col-lg-3 d-none d-lg-block ">
            <a  href="<?=json_decode(file_get_contents('env.json'))->base_url ?>" class="text-decoration-none">
        ...
        <div class="col-lg-3 col-6 text-right">
            <a href="<?=json_decode(file_get_contents('env.json'))->base_url?>/cart" class="btn border bg-white">
                <i class="fas fa-shopping-cart text-primary"></i>
                <span class="badge"><?=$count?></span>
            </a>
            <a href="<?=json_decode(file_get_contents('env.json'))->base_url?>/logout" class="btn btn-danger text-white">
